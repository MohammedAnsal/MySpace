...
export default function SignIn() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#E2E1DF] relative">
      {/* Top Right Login Button */}
      <div className="absolute top-6 right-6">
        <Link
          to="/signin"
          className="bg-[#C4A484] text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-[#B39476] transition"
        >
          Login
        </Link>
      </div>
        ...
        <div className="w-full max-w-sm space-y-6">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-gray-600">
              New here?{" "}
              <Link to="/signup" className="text-[#C4A484] hover:underline">
                Create an account
              </Link>
            </p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <button
              className="w-full bg-[#C4A484] hover:bg-[#B39476] text-white py-3 rounded-lg font-semibold transition duration-200"
              type="submit"
            >
              Login
            </button>
