...
const RoomOptionsSection = ({ selectedGender, setSelectedGender, filteredHostels }: RoomOptionsSectionProps) => {
  ...
  return (
    <section className="py-16 bg-[#F8F8F8] px-4">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-italiana text-4xl md:text-5xl text-center mb-10">Find Your Space</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {filteredHostels?.length > 0 ? (
            filteredHostels.slice(0, 2).map((hostel, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex items-end p-6">
                  <div>
                    <h3 className="text-white text-2xl font-medium mb-2">{hostel.hostel_name}</h3>
            ...
            [
              { src: m2, title: "Boys Hostel", desc: "Modern accommodations designed for male students and professionals" },
              { src: main_pic_1, title: "Girls Hostel", desc: "Safe and comfortable spaces for female students and professionals" },
            ].map((room, index) => (
              <motion.div 
                key={index} 
                className="relative h-80 rounded-xl overflow-hidden cursor-pointer group"
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex items-end p-6">
                  <div>
                    <h3 className="text-white text-2xl font-medium mb-2">{room.title}</h3>
