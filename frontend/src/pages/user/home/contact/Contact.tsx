          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="font-italiana text-3xl md:text-4xl mb-6">Get in Touch</h2>
                <div className="space-y-8 font-dm_sans">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-1 text-gray-900">Address</h3>
                      <p className="text-gray-700">123 Main Street, Kochi, Kerala, India</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 rounded-full bg-[#384f95] flex items-center justify-center text-white hover:bg-[#2d3f75] transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                      </svg>
                    </a>
                    <a href="#" className="w-10 h-10 rounded-full bg-[#B58C5F] flex items-center justify-center text-white hover:bg-[#a07a4f] transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <section className="py-16 px-4 bg-[#F8F8F8]">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="font-dm_sans text-gray-700">Visit our office to learn more about our services</p>
            </motion.div>
        ...
        <section className="py-16 px-4 bg-[#F8F8F8]">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-italiana text-3xl md:text-4xl mb-4">Frequently Asked Questions</h2>
              <p className="font-dm_sans text-lg text-gray-700">Find quick answers to common questions about our services</p>
            </motion.div>
            ...
            <div className="space-y-6">
              {[
                ...
                >
                  ...
                  >
                    <div className={`p-6 border-l-4 border-[#${faq.color}] transition-all duration-300 hover:bg-gray-50`}>
