...
const StayDuration: React.FC<StayDurationProps> = React.memo(
  ({
    startDate,
    selectedMonths,
    selectedFacilities,
    ...
    const handleMonthsChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      if (!validateMinimumStay(startDate, newDuration)) {
        ...
        console.warn(
          "Selected duration may not meet minimum 1-month requirement"
        );
      }
          ...
          <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-md">
            <div className="flex items-center">
              ...
              <p className="text-sm text-amber-700">
                <strong>Minimum Stay Required:</strong> Your selected duration
                may not meet the minimum 1-month stay requirement. Please ensure
                your check-out date is at least 1 month from your check-in date.
              </p>
            </div>
          </div>
        )}
