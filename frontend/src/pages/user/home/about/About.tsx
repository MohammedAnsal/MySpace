            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4 font-dm_sans text-gray-700">
                  <p>
                    Founded in 2023, MySpace began with a simple mission: to
                    create comfortable, safe, and affordable living spaces for
                    students and young professionals.
                  </p>
                  <p>
                    We understand the challenges of finding the right
                    accommodation that balances quality, affordability, and
                    community. Our founder experienced these struggles firsthand
                    as a student, which inspired the creation of MySpace.
                  </p>
                  <p>
                    What started as a small collection of properties has grown
                    into a trusted platform connecting quality hostels with
                    individuals seeking their ideal living space.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="font-dm_sans text-lg text-gray-700 max-w-3xl mx-auto">
                To provide exceptional living experiences by connecting quality
                accommodation providers with individuals seeking their ideal
                home away from home.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  We believe in fostering connections and creating environments
                  where lasting friendships can flourish.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  We prioritize the safety and well-being of our users through
                  thorough verification and transparent processes.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  ...
                  listed accommodations for an exceptional living experience.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="font-dm_sans text-lg text-gray-700 max-w-3xl mx-auto">
                Meet the dedicated professionals behind MySpace who work
                tirelessly to ensure we deliver the best accommodation options
                for our users.
              </p>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl font-dm_sans italic mb-6">
                We believe that everyone deserves a place that feels like home,
                regardless of where life takes them. Our mission is to create
                those spaces and foster communities where memories are made.
              </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg mb-8 max-w-2xl mx-auto font-dm_sans text-gray-700">
                Whether you're looking for a place to stay or have a property to
                list, MySpace is here to help you find the perfect match.
              </p>
              <motion.button
