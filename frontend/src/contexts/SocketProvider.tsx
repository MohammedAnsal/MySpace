...
export const SocketProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    if (isAuthenticated && userId) {
      console.log('Authenticated user detected, establishing socket connection');
      ...
      socketService.addEventListener('initial_online_users', handleInitialOnlineUsers);
      ...
      return () => {
        ...
        socketService.removeEventListener('user_status_changed', handleUserStatus);
        socketService.removeEventListener('initial_online_users', handleInitialOnlineUsers);
