    ...
    <main className="min-h-screen bg-[#E2E1DF]">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-4">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center text-white">
          ...
          >
            Find your perfect place to stay — where comfort meets convenience. A
            home away from home designed with you in mind.
          </motion.p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-italiana text-4xl md:text-5xl text-center mb-16">
            What We Offer
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Carefully curated hostels and PGs that prioritize comfort,
            ...
            >
              ...
              <p className="text-gray-600">
                Hassle-free booking process with secure payments and transparent
                pricing.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Connect with like-minded individuals in a friendly and
      ...
      <section className="py-16 bg-[#F8F8F8] px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-italiana text-4xl md:text-5xl text-center mb-12">
            Find Your Space
          </h2>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex items-end p-6">
                <div>
                  ...
                  <p className="text-white/80 mb-4">
                    Modern accommodations designed for male students and
                    professionals
                  </p>
                  <motion.button
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex items-end p-6">
                <div>
                  ...
                  <p className="text-white/80 mb-4">
                    Safe and comfortable spaces for female students and
                    professionals
                  </p>
                  <motion.button
                    className="text-white font-medium flex items-center"
      ...
      <section className="py-20 bg-[#384f95] text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl mb-10 text-white/90">
            List your hostel or PG on our platform and connect with potential
            tenants looking for quality accommodations.
          </p>
          <motion.button
            onClick={() => handleRoleSelection("provider")}
            className="px-8 py-4 bg-white text-[#384f95] font-medium rounded-lg shadow-lg hover:bg-gray-100 transition-all"
